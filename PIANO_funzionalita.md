...
| **Temperatura di fissaggio** (2026-09-04) | **da decidere prima dell'addestramento.** Le 51 schede hanno il solo minimo e la regola dello spec §2.6 chiede minimo **e** massimo: quel valore non verrà mai segnalato fuori range. Cambiare la regola in "massimo assente = nessun limite superiore" è una modifica allo spec approvato (vista, colore del tablet e test di coerenza insieme) e sarà una fase a sé |
